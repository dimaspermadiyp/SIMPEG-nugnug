  ...
  <body>
	...
	<?php } ?>
      <div class="hero-unit">
        ...
        <p>Sistem Informasi Kepegawaian PNS Karanganyar merupakan sebuah aplikasi untuk melakukan manajemen data kepegawaian untuk pegawai negeri sipil (PNS) di Kabupaten Karanganyar. Silahkan masukkan username dan password anda untuk mulai untuk melakukan manajemen atau pengolahan data kepegawaian sesuai dengan hak akses yang anda miliki.</p>
